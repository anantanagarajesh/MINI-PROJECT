...
class RecieveBG extends StatefulWidget {
  const RecieveBG({super.key});

  @override
  _DonorBGState createState() => _DonorBGState();
}

class _DonorBGState extends State<RecieveBG> {
  ...
  Widget bloodGroupButton(String bloodType) {
    ...
    return TextButton(
      ...
      style: TextButton.styleFrom(
        ...
        backgroundColor:
            isSelected ? const Color(0xffff3737) : const Color(0xffd9d9d9),
      ),
      child: Container(
        width: 70 * fem,
        height: 70 * fem,
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        ...
                                        disabledBackgroundColor:
                                            const Color.fromARGB(255, 236, 135,
